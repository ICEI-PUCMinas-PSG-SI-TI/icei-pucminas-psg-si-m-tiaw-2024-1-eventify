...
function loadUserInfo() {
    ...
    if (personData && personData.id) {
        ...
        <a href="/pages/create-edit-event.html"> <h1 class="create-event-title">Criar um evento</h1> </a>
        <div class="dropdown">
            ${userPhoto}
            <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="/pages/create-edit-event.html">Criar evento</a></li>
...
function eventClick(id) {
    window.location = "/pages/event.html?ev=" + id;
}
